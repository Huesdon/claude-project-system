# p004 — Canonical Reference Docs: CPS_Task_Module.md

**ID:** `p004-cps-task-module-doc`
...
### Action a — Create or upgrade `Reference/Claude/CPS_Task_Module.md`

Skip if both detection checks pass (file exists AND contains `<!-- rev: 2 -->`).
